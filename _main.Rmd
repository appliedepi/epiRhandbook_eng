...
* Serve as a quick R code reference manual (online and **[offline][Download handbook and data]**)  
* Provide task-centered examples addressing common epidemiological problems  

*Total beginners are encouraged to try our [interactive tutorials](www.appliedepi.org/tutorial) or [intro course](www.appliedepi.org/live) first.*
