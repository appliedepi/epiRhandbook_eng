...
<!-- ======================================================= -->
## Regular expressions (regex) and special characters { } 
...
Additionally, the package [**RVerbalExpressions**](https://rverbalexpressions.netlify.app/) can offer an easy way to construct regular expressions.
