...
Plotly is not just for R, but also works well with Python and Julia (and really any data science language as it's built in JavaScript). You can read more about it on the [plotly website](https://plotly.com/r/).
