...
* See the [Suggested packages](packages_suggested.qmd) page to assist you with installing appropriate R packages before you lose internet connectivity. You will not be able to install new packages without internet access.  
...
<span style="color: black;">**_NOTE:_** Structured contact tracing data from other software (e.g. KoBo, DHIS2 Tracker, CommCare) may look different. If you would like to contribute alternative sample data or content for this page, please [contact us](https://epirhandbook.com/#r-for-applied-epidemiology-and-public-health).</span> 

<span style="color: darkgreen;">**_TIP:_** If you are deploying Go.Data and want to connect to your instance's API, see the Import and export page [(API section)](#import_api) and the [Go.Data Community of Practice](https://worldhealthorganization.github.io/godata/).</span>
...
For the [survey analysis](https://epirhandbook.com/new_pages/survey_analysis.html) page we use fictional mortality survey data based off MSF OCA survey templates. This fictional data was generated as part of the ["R4Epis" project](https://r4epis.netlify.app/).
