...
Again we have downloaded the locations of health facilities from HDX [here](https://data.humdata.org/dataset/hotosm_sle_health_facilities) or via instructions in the [Download handbook and data](#data-used) page.   
...
**Note: If you right click on [Google Maps](https://www.google.com/maps) it will display the coordinates of the point**.
...
1) Create basemap tile, as described above
