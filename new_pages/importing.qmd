...
Bonus! If you do have a second row that is a data dictionary, you can easily create a proper data dictionary from it. This tip is adapted from this [post](https://www.apreshill.com/blog/2018-07-multiple-headers/).  
...
[Google sheets importing tutorial](https://felixanalytix.medium.com/how-to-read-write-append-google-sheet-data-using-r-programming-ecf278108691). 
...
See the page on [Iteration, loops, and lists](iteration.qmd) for examples of how to import and combine multiple files, or multiple Excel workbook files. 
