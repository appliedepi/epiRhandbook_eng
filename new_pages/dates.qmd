...
Another function we can use is `fix_date_df` from the [**datefixR** package](https://docs.ropensci.org/datefixR/). This package can take in a wide variety of different, messy, date formats at the same time and set them to a standard format!
...
For a list of the languages that can be used, and additional functions and limitations, please see the [website](https://docs.ropensci.org/datefixR/).
...
[Online tutorial](https://campus.datacamp.com/courses/intermediate-r/chapter-5-utilities?ex=12)
