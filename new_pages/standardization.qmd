...
standard_pop_clean <- standard_pop_data %>%
     rename(age_cat5 = AgeGroup) %>%                 #Change name of age group column to match that in our population data and death counts
     mutate(
...
For another example using **PHEindicatormethods**, please go to [this website](https://cran.r-project.org/web/packages/PHEindicatormethods/vignettes/Introduction_to_PHEindicatormethods.html).  
