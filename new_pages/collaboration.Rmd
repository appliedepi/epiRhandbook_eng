...
git push   # Push local commits of this branch to the remote branch
```
...
This is usually *main*, but it could be another branch. Then merge your
working branch into main.

```{bash, eval = FALSE}
git checkout main  # Go back to main (or to the branch you want to move your )
...
people before being integrated to the main branch. To help with the
...
the other branch (which may be origin, main or any branch of
your choice).
