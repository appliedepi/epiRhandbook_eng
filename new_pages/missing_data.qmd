...
The online book we mentioned earlier by the author of the **mice** package ([https://stefvanbuuren.name/fimd/](https://stefvanbuuren.name/fimd)) contains a detailed explanation of multiple imputation and why you'd want to use it. But, here is a basic explanation of the method:
