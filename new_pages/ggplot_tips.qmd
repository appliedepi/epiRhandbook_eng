...
See a complete example in the Epicurves page section on [multi-level date labels](epicurves.qmd#multi-level-date-labels), but a quick example is shown below for reference:  
