...
<span style="color: orange;">**_CAUTION:_** Joins are case-specific! Therefore it is useful to convert all values to lowercase or uppercase prior to joining. See the page on [characters/strings](characters_strings).</span>
...
The [tidyverse page on joins](https://dplyr.tidyverse.org/reference/mutate-joins.html).  
